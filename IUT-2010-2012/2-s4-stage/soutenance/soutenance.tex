...
\newcommand{\logoIUT}{\includegraphics[height=0.75cm]{logoIUT.png}}
\newcommand{\logoMBX}{\includegraphics[height=0.7cm]{logoMemobox.png}}
\input{styles/listings.tex}
\title[\logoIUT{} \logoMBX]
{Refonte du système multilingue d'une application Web}
...
\institute[Universités de Quelque Part et d'Ailleurs] % (facultatif mais généralement nécessaire)
{
  ...
  Stage effectué à Memobox / 2G Technologies
}
...
\setbeamertemplate{footline}{
	...
	\begin{beamercolorbox}[wd=.63\paperwidth,ht=2.25ex,dp=1ex,center]{section in head/foot}%
		\usebeamerfont{section in head/foot}~~~~~~~~~~~~~~~~~Refonte du système de traduction d AUDITELcom
	\end{beamercolorbox}%

	\begin{beamercolorbox}[wd=.23\paperwidth,ht=2.25ex,dp=1ex,right]{section in head/foot}%
		\usebeamerfont{section in head/foot}\insertshortdate{}\hspace*{2em}
		\hspace{4cm}\insertframenumber{} / \inserttotalframenumber\hspace*{2ex}
	\end{beamercolorbox}}%
					\vskip0pt%
}
...
\section{Les objectifs du stage}
	...
	\begin{frame}{Le sujet : Refonte du système multilingue}
		% Plus précisions
		% Pourquoi le refondre ?
		% Introduction des solutions choisis
	\end{frame}
	...
	\subsection{Projet professionnel}
		\begin{frame}
			\begin{itemize}
				...
				\item Licence en vue d'un master
			\end{itemize}
		\end{frame}
\end{document}
