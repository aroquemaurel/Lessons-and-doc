\documentclass[12pt,a4paper,towside]{book}
...
\begin{document}
	...
	\thispagestyle{empty} 
	\frontmatter
	\include{contenu/avantPropos/remerciements}
	\tableofcontents
	\mainmatter
	\chapter{test 1}
	\section{kamoulox 1}
	...
	\section{kamoulox 4}
	\lipsum 
%	\include{includes/chapitre4}
%	\include{includes/chapitre5}
%	\include{includes/chapitre6}
	\closeout\glossaireVar
	\appendix

%	\include{includes/annexes/listeAnnonceurs}
%	\include{includes/annexes/listeTableauxCh6}
...
%	\chapter{Glossaire}
%	\begin{sortedlist}
	%	\input{includes/annexes/glossaire}
%	\end{sortedlist}
\end{document}
