...
\lstinputlisting[language=Prolog]{code3.pl}
...
\end{definition}
\lstinputlisting[language=Prolog, caption=eliminer avec \textit{Cut}]{code4.pl}
\lstinputlisting[language=Prolog, caption=maximum avec \textit{Cut}]{code5.pl}
\lstinputlisting[language=Prolog, caption=intersection avec \textit{Cut}]{code6.pl}
