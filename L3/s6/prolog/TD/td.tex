...
\begin{document}
	...
	\lstinputlisting[language=Prolog,caption=Arbre binaire]{exo4.pl}
	\subsection{Exercice 4 -- Arbre binaire étiqueté}
	\lstinputlisting[language=Prolog,caption=Arbre binaire étiqueté]{exo4-1.pl}
	\subsection{Listes}
	\lstinputlisting[language=Prolog,caption=Méthodes sur les listes]{exo5.pl}
	\lstinputlisting[language=Prolog,caption=Tri pivot]{exo6.pl}
	\lstinputlisting[language=Prolog,caption=Tri par insertion]{exo7.pl}
	\lstinputlisting[language=Prolog,caption=Nuplet]{exo8.pl}
	\appendix
	\lstlistoflistings
