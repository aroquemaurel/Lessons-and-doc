...
syntax match    adaOperator "\<et\>"
syntax match    adaOperator "\<and\s\+then\>"
syntax match    adaOperator "\<ou\>"
...
" Boolean Constants.
syntax keyword adaBoolean 	Vrai Faux	
...
"
syntax match adaStructure "\<enregistrement\>"	contains=adaRecord
syntax match adaStructure "\<tableau\>"	contains=adaRecord
syntax match adaStructure "\<pointeur\>"	contains=adaRecord
syntax match adaStructure "\<sur\>"	contains=adaRecord
...
syntax match    adaStructure	 "\<fonction\>"	 contains=adaPackage
syntax match    adaStructure	"\<procedure\>"	 contains=adaPackage
syntax match    adaStructure	"\<importer\>"	 contains=adaPackage
syntax match    adaStructure	"\<programme\>"	 contains=adaPackage
