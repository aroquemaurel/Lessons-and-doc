...
taille=lseek(fd,0,seek_end);
		\end{lstlisting}
		\section{Exercice 19}
		\lstinputlisting[language=C, caption=Exercie 19]{codes/19.c}
		\section{Exercice 20}
		\lstinputlisting[language=C, caption=Exercie 20]{codes/20.c}
		\section{Exercice 21}
		\lstinputlisting[language=C, caption=Exercie 21]{codes/21.c}
		\chapter{Fonctions de la bibliothèque standard pour la manipulation des fichiers}
		\lstinputlisting[language=C, caption=Exemple 1]{codes/ex1.c}
		\lstinputlisting[language=C, caption=Exemple 2]{codes/ex2.c}
		\lstinputlisting[language=C, caption=Exemple 3]{codes/ex3.c}
