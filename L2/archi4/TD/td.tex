...
\end{lstlisting}
\begin{tabular}{p{6cm}p{6cm}}
\lstinputlisting[language=Algo,linewidth=8cm]{3-3.algo}
	&
\lstinputlisting[linewidth=8cm,language=ARM]{3-3.s}
\end{tabular}
\begin{tabular}{l l}
	[rj] & \texttt{Mem32[Rj]}\\
	\hline
...
\begin{tabular}{p{6cm}p{6cm}}
\lstinputlisting[language=Algo,linewidth=8cm]{4.algo}
	&
\lstinputlisting[linewidth=8cm,language=ARM]{4.s}
\end{tabular}
\section{Tris à bulles}
\begin{tabular}{p{6cm}p{6cm}}
\lstinputlisting[language=Algo,linewidth=8cm]{5.algo}
	&
\lstinputlisting[linewidth=8cm,language=ARM]{5.s}
\end{tabular}
\chapter{Sous programmes}
\section{rechmax}
\begin{tabular}{p{6cm}p{6cm}}
\lstinputlisting[language=Algo,linewidth=8cm]{6.algo}
	&
\lstinputlisting[linewidth=8cm,language=ARM]{6.s}
\end{tabular}
\section{atoi}
\begin{tabular}{p{6cm}p{6cm}}
\lstinputlisting[language=Algo,linewidth=8cm]{7.algo}
	&
\lstinputlisting[linewidth=8cm,language=ARM]{7.s}
\end{tabular}
\section{itoa}
\begin{tabular}{p{6cm}p{6cm}}
\lstinputlisting[language=Algo,linewidth=8cm]{8.algo}
	&
\lstinputlisting[linewidth=8cm,language=ARM]{8.s}
\end{tabular}
\appendix
\end{document}
