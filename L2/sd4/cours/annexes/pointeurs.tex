\chapter{Cours sur les pointeurs en C}\ref{pointeurs}
...
\attention{La case mémoire ne met pas à jour la case mémoire, celle-ci contient toujours la valeur, si personne ne récupère la case, il sera toujours
possible d'accéder à la donnée, cependant cela est aléatoire, cela peut être source d'erreurs}
