...
\end{itemize}
\lstinputlisting[language=C, caption=Implémentation des fonctions du type Pile en statique]{content/1.c}
\subsubsection{Implémentation dynamique du TAD \texttt{Pile}}
\lstinputlisting[language=C, caption=Implémentation des fonctions du type Pile en dynamique]{content/pileDynamique.c}
